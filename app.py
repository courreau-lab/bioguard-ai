...
try:
    if "GEMINI_API_KEY" in st.secrets:
        ...
        st.warning("⚠️ Key Missing: Add GEMINI_API_KEY in Streamlit Secrets.")
...
with tabs[0]: # LOGIN
    ...
    if not st.session_state.logged_in:
        ...
        u = st.text_input("Username", value="admin", key="u_final")
